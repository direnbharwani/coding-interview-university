...
<h1 align="center"> Coding Interview University </h1>

<p align="center">
    A structured approach to studying for coding interviews. <br/>
    Forked and modified from <a href="https://github.com/jwasham/coding-interview-university">https://github.com/jwasham/coding-interview-university</a>
</p>

<h2>The Study Plan</h2>
<ul>
    <li><a href="#dont-feel-you-arent-smart-enough">Don't feel you aren't smart enough</a></li>
    <li><a href="#use-flashcards">Use Flashcards</a></li>
    <li><a href="#coding-interview-questions">Do coding interview questions while learning</a></li>
    <li><a href="#focus">Focus</a></li>
    <li><a href="#coding-interview-practice">Coding Interview Books and Questions</a></li>
</ul>

<h2>Topics of Study</h2>
<ul>
    <li><a href="#big-o">Algorithmic Complexity & Big-O Notation</a></li>
    <li><a href="#basic-data-structures">Basic Data Structures</a>
        <ul>
            <li><a href="#arrays">Arrays</a></li>
            <li><a href="#linked-lists">Linked Lists</a></li>
            <li><a href="#stack">Stacks</a></li>
            <li><a href="#queue">Queues</a></li>
            <li><a href="#hash-table">Hash Tables</a></li>
        </ul>
    </li>
    <li><a href="#basic-algorithms">Basic Algorithms</a>
        <ul>
            <li><a href="#binary-search">Binary Search</a></li>
            <li><a href="#bitwise-ops">Bitwise Operations</a></li>
            <li><a href="#sorting">Sorting</a>
                <ul>
                    <li><a href="#selection-sort">Selection</a></li>
                    <li><a href="#insertion-sort">Insertion</a></li>
                    <li><a href="#heap-sort">Heapsort</a></li>
                    <li><a href="#merge-sort">Mergesort</a></li>
                    <li><a href="#quick-sort">Quicksort</a></li>
                </ul>
            </li>
        </ul>
    </li>
    <li><a href="#advanced-data-structures">Advanced Data Structures</a>
        <ul>
            <li><a href="#trees">Trees</a>
                <ul>
                    <li><a href="#bst">Binary Search Trees</a></li>
                    <li><a href="#heap">Heap</a></li>
                    <li><a href="#balanced-search-tree">Balanced Search Trees</a></li>
                    <li><a href="#tree-traversal">Tree Traversals</a></li>
                </ul>
            </li>
            <li><a href="#graphs">Graphs</a>
                <ul>
                    <li><a href="#types">Types: Directed, Undirected, Weighted</a></li>
                    <li><a href="#representations">Representations: Adjacency Matrix/List</a></li>
                    <li><a href="#traversals">Graph Traversals: BFS & DFS</a></li>
                </ul>
            </li>
        </ul>
    </li>
    <li><a href="#advanced-algorithms">Advanced Algorithms</a>
        <ul>
            <li><a href="#recursion">Recursion & Recurrence Relations</a></li>
    ...
    <li><a href="#more-knowledge">More Knowledge</a>
        <ul>
            ...
            <li><a href="#np">NP, NP-Complete & Approximation Algorithms</a></li>
            <li><a href="#processing">How computers process a program</a></li>
            <li><a href="#caches">Caches</a></li>
            <li><a href="#processes-&-threads">Processes & Threads</a></li>
            <li><a href="#strings">String searching & manipulation</a></li>
...
<div id="dont-feel-you-arent-smart-enough">
    <h3>Don't feel you aren't smart enough</h3>
    <ul>
        <li>Successful software engineers are smart, but many have an insecurity that they aren't smart enough.</li>
        <li>The following videos may help you overcome this insecurity</li>
        <ul>
...
<div id="use-flashcards">
    <h3>Use Flashcards</h3>
    <p>
        The first time you recognize you know the answer, don't mark it as known. You have to see the same card and answer it several times correctly before you really know it. Repetition will put that knowledge deeper in your brain.
    </p>
    <p align="right">(<a href="#readme-top">back to top</a>)</p>
</div>

<div id="coding-interview-questions">
    <h3>Do Coding Interview Questions While You're Learning</h3>
    <p>
        THIS IS VERY IMPORTANT. Start doing coding interview questions while you're learning data structures and algorithms. <br/>
        You need to apply what you're learning to solve problems, or you'll forget. I made this mistake. <br/>
        <br/>
        Once you've learned a topic, and feel somewhat comfortable with it:
        <ol type="1">
            <li>Open one of the <a href="#coding-interview-practice">coding interview books or websites.</a></li>
            <li>Do 2 or 3 questions regarding the topic.</li>
            <li>Move on to learning the next topic.</li>
            <li>Later, go back and do another 2 or 3 linked list problems.</li>
            <li>Do this with each new topic you learn.</li>
        </ol>
        <br/>
        <b>Keep doing problems while you're learning all this stuff, not after.</b><br/>
        You're not being hired for knowledge, but how you apply the knowledge.<br/>
    </p>
    <p align="right">(<a href="#readme-top">back to top</a>)</p>
</div>
...
<div id="coding-interview-practice">
    <h3>Coding Interview Books and Questions</h3>
    <p>
        Why you need to practice doing programming problems:<br/>
        <ul>
        ...
        There is an outstanding intro for methodical, communicative problem-solving in an interview here:<a href="http://www.hiredintech.com/algorithm-design/"></a>Algorithm design canvas<br/>
        Write code on a whiteboard or paper, not a computer. Test with some sample inputs. Then type it and test it out on a computer.<br/>
    </p>
    <h4>Coding Books</h4>
    <ul>
        <li><a href="http://www.amazon.com/Cracking-Coding-Interview-6th-Programming/dp/0984782850/">Cracking the Coding Interview, 6th Edition</a></li>
    </ul>
    ...
    <ul>
        ...
        <li><a href="https://neetcode.io//">NeetCode</a></li>
            <ul><li>My favourite site for a structured approach to practicing leetcode questions with walk-throughs.</li></ul>
    </ul>
    <br/>
    <p><b>Coding question practice is not about memorizing answers to programming problems.</b></p>
    <p align="right">(<a href="#readme-top">back to top</a>)</p>
</div>

<div id="big-o">
    <h2>Algorithmic Complexity & Big-O Notation</h2>
    <p>Nothing to implement here, just watch enough until you understand it.</p>
    <ul>
        <li><a href="https://www.youtube.com/watch?v=iOq5kSKqeR4">Harvard CS50 - Asymptotic Notation</a></li>
        <li><a href="https://www.youtube.com/watch?v=BgLTDT03QtU">Big-O Notation - For Coding Interviews</a></li>
    </ul>
    <p>
...
<ul>
    <li><a href="https://www.youtube.com/watch?v=tI_tIZFyKBw&t=3009s">Harvard CS50 - Arrays</a></li>
    <li><a href="https://archive.org/details/ucberkeley_webcast_Wp8oiO_CZZE">UCB CS61B - Linear and Multi-Dim Arrays</a> (Start watching from 15m 32s)</li>
    <li><a href="https://www.youtube.com/watch?v=1jtrQqYpt7g">Jagged Arrays</a></li>
</ul>

<details>
  <summary><b>Implement a vector (mutable array with automatic resizing)</b></summary>

  - [x] New raw data array with alloacted memory
      - Allocate under the hood, use powers of 2
  - [x] size()
      - number of items
  - [x] capacity()
...
<ul>
    <li><a href="https://www.youtube.com/watch?v=2T-A_GFuoTo&t=650s">Harvard CS50 - Linked Lists</a></li>
    <li><a href="https://archive.org/details/ucberkeley_webcast_htzJdKoEmO0">UCB CS61B - Linked Lists 1</a></li>
    <li><a href="https://archive.org/details/ucberkeley_webcast_-c4I3gFYe3w">UCB CS61B - Linked Lists 2</a></li>
    <li><a href="https://www.youtube.com/watch?v=YQs6IC-vgmo">Why you should avoid linked lists</a></li>
</ul>

<details>
  <summary><b>Implement (with and without tail)</b></summary>
